...
public interface IUsuarioService
{
    ...
    Task<CrearUsuarioResponse> CrearUsuarioSemanalAsync(CrearUsuarioSemanalRequest request, int idUsuarioAlta);

    Task<UsuarioOperacionResponse> EditarUsuarioAsync(int idUsuario, EditarUsuarioRequest request, int idUsuarioModificacion);

    Task<UsuarioOperacionResponse> EditarUsuarioSemanalAsync(int idUsuario, EditarUsuarioSemanalRequest request, int idUsuarioModificacion);
    ...
    Task<UsuarioOperacionResponse> ReactivarUsuarioSemanalAsync(int idUsuario, ReactivarUsuarioSemanalRequest request, int idUsuarioModificacion);

    Task<UsuarioOperacionResponse> ValidarSuperUsuarioAsync(int idUsuario);

    Task<UsuarioOperacionResponse> ActualizarPermisosSemanalesAsync(int idUsuario, ActualizarPermisosSemanalesRequest request, int idUsuarioModificacion);
}